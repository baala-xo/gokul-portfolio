  ...
  const skillCategories = [
    {
      ...
      title: "Programming",
      skills: ["HTML", "Python", "C Programming", "SQL"],
    },
    {
      icon: <Server className="h-6 w-6" />,
      title: "Technologies / Tools",
      skills: ["Web Development", "SQL Developer", "Excel", "Database Management"],
    },
    {
      icon: <Palette className="h-6 w-6" />,
      title: "Areas of Interest",
      skills: ["Data Science", "IoT", "Augmented Reality", "Mobile App Development"],
    },
    {
